// color foo
var lightctrl = require('./ctrl.js');
var controller    = new lightctrl.Controller("10.10.10.10", 1, 1);
...
var pixel   = new lightctrl.Pixel(controller, 1);
var pixel2  = new lightctrl.Pixel(controller, 4);
var pixel3  = new lightctrl.Pixel(controller, 7);
